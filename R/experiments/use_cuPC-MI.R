...
cat("\n")
tic()
cuda_PC_MI <- cu_pc_MI(suffStatMI, p = p, alpha = alpha, m.max = max_order, df_method = "br")
print(cuda_PC_MI)
cat("\n")
cat("Time consumed:\n")
toc()
...
cat("\n")
tic()
cuda_PC_SI <- cu_pc_MI(suffStatMI, p = p, alpha = alpha, m.max = max_order, df_method = "old")
print(cuda_PC_SI)
cat("\n")
cat("Time consumed:\n")
toc()
